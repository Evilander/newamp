...
- **Audio controls and conversion.** 10-band EQ, presets, ReplayGain, limiter, preamp, crossfade/gapless handoff, output-device selection, in-app left/right speaker test, current-track WAV export, and selected-track batch WAV folder export.
