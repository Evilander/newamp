...
- **Custom playlists.** Create named playlists, filter large playlist lists/tracks, append tracks in bulk, add folders, pick or drop playlist artwork, export portable copied playlist folders, and launch playlists directly from Home.
