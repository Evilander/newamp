...
const stub: NewAmpAPI = {
  ...
  showTrackContextMenu: async () => null,
  ...
  analyzeTracksDna: async () => ({ analyzed: 0, skipped: [], total: 0 }),
  ...
  deleteTagRule: async () => undefined,
  setTagRuleEnabled: async () => null,
  recomputeTags: async () => ({ rulesEvaluated: 0, tracksEvaluated: 0, tagsAssigned: 0, errors: {} }),
  getTagsForTrack: async () => [],
  getTagSummaries: async () => [],
  previewTagRule: async () => ({ ok: false, errors: [], ruleName: null, references: [], matchCount: 0, sampleTrackIds: [] }),
  getTrackIdsByTag: async () => [],
  ...
  setAlbumRatingScore: async () => null,
  getAlbumRating: async () => null,
  ...
  exclusiveSupported: async () => false,
  exclusiveListDevices: async () => [],
  exclusivePlay: async () => ({ ok: false, error: 'Exclusive output is only available in the Electron app.' }),
  exclusivePause: async () => undefined,
  exclusiveResume: async () => undefined,
  exclusiveStop: async () => undefined,
  exclusiveSeek: async () => undefined,
